...
namespace zcm
{
    ...
    vec4  zcm_vectorcall abs (zcm::vec4 x) noexcept;
    ...
    vec4  zcm_vectorcall ceil (zcm::vec4 x) noexcept;
    ...
    vec4  zcm_vectorcall clamp (zcm::vec4 x, zcm::vec4 minVal, zcm::vec4 maxVal) noexcept;
    ...
    vec4  zcm_vectorcall floor (zcm::vec4 x) noexcept;
    ...
    vec4  zcm_vectorcall fma(zcm::vec4 a, zcm::vec4 b, zcm::vec4 c) noexcept;

    float fract (float x) noexcept;
    vec2  fract (const vec2& x) noexcept;
    vec3  fract (const vec3& x) noexcept;
    vec4  zcm_vectorcall fract (zcm::vec4 x) noexcept;
    ...
    bvec4 zcm_vectorcall isinf (zcm::vec4 x) noexcept;
    ...
    bvec4 zcm_vectorcall isnan (zcm::vec4 x) noexcept;
    ...
    vec4  zcm_vectorcall max (zcm::vec4 x, zcm::vec4 y) noexcept;
    ...
    vec4  zcm_vectorcall min (zcm::vec4 x, zcm::vec4 y) noexcept;
    ...
    vec4  zcm_vectorcall signNotZero (zcm::vec4 x) noexcept;
    ...
    vec4  zcm_vectorcall mix (zcm::vec4 x, zcm::vec4 y, float t) noexcept;
    vec2  mix (const vec2& x, const vec2& y, const vec2& t) noexcept;
    vec3  mix (const vec3& x, const vec3& y, const vec3& t) noexcept;
    vec4  zcm_vectorcall mix (zcm::vec4 x, zcm::vec4 y, zcm::vec4 t) noexcept;
    ...
    vec4  zcm_vectorcall mix (zcm::vec4 x, vec4 y, const bvec4& t) noexcept;
    ...
    vec4  zcm_vectorcall step (zcm::vec4 edge, zcm::vec4 x) noexcept;
    ...
    vec4  zcm_vectorcall smoothstep (zcm::vec4 edge0, zcm::vec4 edge1, zcm::vec4 x) noexcept;

    float trunc (float x) noexcept;
    vec2  trunc (const vec2& x) noexcept;
    vec3  trunc (const vec3& x) noexcept;
    vec4  zcm_vectorcall trunc (zcm::vec4 x) noexcept;
    ...
    bvec4 zcm_vectorcall equal (zcm::vec4 x, zcm::vec4 y) noexcept;
    ...
    bvec4 zcm_vectorcall notEqual (zcm::vec4 x, zcm::vec4 y) noexcept;
