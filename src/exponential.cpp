...
zcm::vec4 zcm_vectorcall zcm::sqrt(zcm::vec4 x) noexcept
{
    return { zcm::sqrt(x.x), zcm::sqrt(x.y), zcm::sqrt(x.z), zcm::sqrt(x.w)};
}

zcm::quat zcm_vectorcall zcm::sqrt(zcm::quat x) noexcept
{
...
zcm::vec4 zcm_vectorcall zcm::pow(zcm::vec4 x, zcm::vec4 y) noexcept
{
    return { zcm::pow(x.x, y.x), zcm::pow(x.y, y.y),  zcm::pow(x.z, y.z), zcm::pow(x.w, y.w)};
}

zcm::quat zcm_vectorcall zcm::pow(zcm::quat x, float y) noexcept
{
...
zcm::vec4 zcm_vectorcall zcm::log(zcm::vec4 x) noexcept
{
    return { zcm::log(x.x), zcm::log(x.y), zcm::log(x.z), zcm::log(x.w) };
}


zcm::quat zcm_vectorcall zcm::log(zcm::quat x) noexcept
{
...
zcm::vec4 zcm_vectorcall zcm::log2(zcm::vec4 x) noexcept
{
    return { zcm::log2(x.x), zcm::log2(x.y), zcm::log2(x.z), zcm::log2(x.w) };
}


zcm::quat zcm_vectorcall zcm::log2(zcm::quat x) noexcept
{
...
zcm::vec4 zcm_vectorcall zcm::inversesqrt(zcm::vec4 x) noexcept
{
    return 1.0f / zcm::sqrt(x);
}

zcm::quat zcm_vectorcall zcm::inversesqrt(zcm::quat x) noexcept
{
    return 1.0f / zcm::sqrt(x);
}
...
zcm::vec4 zcm_vectorcall zcm::exp(zcm::vec4 x) noexcept
{
    return {zcm::exp(x.x), zcm::exp(x.y), zcm::exp(x.z), zcm::exp(x.w)};
}

zcm::quat zcm_vectorcall zcm::exp(zcm::quat x) noexcept
{
...
zcm::vec4 zcm_vectorcall zcm::exp2(zcm::vec4 x) noexcept
{
    return {zcm::exp2(x.x),zcm::exp2(x.y), zcm::exp2(x.z), zcm::exp2(x.w)};
}

zcm::quat zcm_vectorcall zcm::exp2(zcm::quat x) noexcept
{
...
zcm::vec4 zcm_vectorcall zcm::cbrt(vec4 x) noexcept
{
	return {zcm::cbrt(x.x), zcm::cbrt(x.y), zcm::cbrt(x.z), zcm::cbrt(x.w)};
}

zcm::quat zcm_vectorcall zcm::cbrt(quat x) noexcept
{
